...
export function Footer() {
  ...
  return (
    <>
      <section id="gifts" className="py-16 px-6 bg-stone-50">
      ...
      <section className="py-12 px-6 bg-stone-200 overflow-hidden">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <motion.p
            className="font-heading text-4xl md:text-5xl text-stone-800 text-center md:text-left"
